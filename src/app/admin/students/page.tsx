...
export const metadata = { title: "Manage Students — Admin" };
    ...
    <div className="min-h-screen bg-gradient-to-b from-detective-slate/10 to-background">
      <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <UserSearchForm defaultValue={searchTerm} />
        </div>
        ...
        <Card className="border-detective-amber/20">
          <CardHeader>
            ...
            <CardDescription>
              {searchTerm
                ? `${totalStudents} result${totalStudents !== 1 ? "s" : ""} for "${searchTerm}"`
                ...
                <TableBody>
                  {students.map((student) => (
                    <TableRow key={student.id}>
                      ...
                      <TableCell>
                        {student.nickname ? (
                          <Badge variant="secondary">{student.nickname}</Badge>
                        ) : (
                      ...
                      <TableCell className="text-center">
                        <Badge variant="secondary">{student.submissionCount}</Badge>
                      </TableCell>
