...
const empty: FormState = { name: "", nickname: "", email: "", password: "" };
...
export function AddTeacherDialog() {
  ...
  function validate(): FieldErrors {
    ...
    if (form.nickname && !/^[a-zA-Z0-9_]+$/.test(form.nickname)) {
      e.nickname = "Only letters, numbers, and underscores allowed";
    }
    return e;
  }
    ...
    >
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a teacher account. They can log in immediately with the provided credentials.
          </DialogDescription>
        </DialogHeader>

        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          <div className="space-y-1">
            <Label htmlFor="teacher-name">Full Name <span className="text-detective-crimson">*</span></Label>
            <Input
              id="teacher-name"
          ...
          <div className="space-y-1">
            ...
            <Input
              id="teacher-nickname"
              placeholder="ms_smith"
              value={form.nickname}
              onChange={handleChange("nickname")}
              disabled={loading}
            />
            {errors.nickname && <p className="text-xs text-detective-crimson">{errors.nickname}</p>}
          </div>

          <div className="space-y-1">
            <Label htmlFor="teacher-email">Email <span className="text-detective-crimson">*</span></Label>
            <Input
              id="teacher-email"
              type="email"
          ...
          <div className="space-y-1">
            <Label htmlFor="teacher-password">Password <span className="text-detective-crimson">*</span></Label>
            <Input
              id="teacher-password"
              type="password"
